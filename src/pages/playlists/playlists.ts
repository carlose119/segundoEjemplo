...
import { PerfilDetallesPage } from '../perfil-detalles/perfil-detalles';
...
export class PlaylistsPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public ds: DeezerServiceProvider, public loadingCtrl: LoadingController, public modalCtrl: ModalController) {
  ...
  goToPerfilDetalle(user, playlists){
    let modal = this.modalCtrl.create(PerfilDetallesPage, {
      user: user,
      playlists: playlists
    });
    modal.present();
